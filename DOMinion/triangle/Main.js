;(function() {
        ...
        try {
          if (typeof object[name] === "function") {
            ...
            return new FieldError(
              name,
              new TypeError$1("function", object[name])
            )
          }
        } catch (error) {
  ...
  class Either {
    ...
    static decode(either, input) {
      ...
      for (let decoder of either) {
        ...
        if (value instanceof Error$2) {
          problems =
            problems == null ? [value] : (problems.push(value), problems)
        } else {
          return value
        }
      }
  ...
  const view$2 = (label$$1, hover, x, y, size) =>
    div(
      [
        dotStyle,
      ...
      [hover ? text(`*${label$$1}*`) : text(label$$1)]
    )
  ...
  const Leave = ok$1({ type: "Leave" })

  const targetSize = 25

  const view$1 = (x, y, size, children) => {
    if (size <= targetSize) {
      return div(
        [],
        [
      ...
      return div(
        [],
        [
          view$1(x, y - size / 2, size, children).map(TagTop.new),
          view$1(x - size, y + size / 2, size, children).map(TagLeft.new),
          view$1(x + size, y + size / 2, size, children).map(TagRight.new)
        ]
      )
    }
  }
  ...
  class Model {
    constructor(seconds, useTimeSlicing, intervalID, start, time) {
      this.useTimeSlicing = true
    ...
    static new(time, intervalID) {
      return new Model(0, true, intervalID, time, time)
    }
    static useTimeSlicing(
      { seconds, intervalID, start, time },
      useTimeSlicing
    ) {
      return new Model(seconds, useTimeSlicing, intervalID, start, time)
    }
    static time({ seconds, intervalID, start, useTimeSlicing }, time) {
      return new Model(seconds, useTimeSlicing, intervalID, start, time)
    }
    static beat({ seconds, intervalID, start, useTimeSlicing, time }) {
      return new Model(
        seconds % 10 + 1,
        useTimeSlicing,
        intervalID,
  ...
  const viewToggle = (useTimeSlicing, onLabel, offLabel) =>
    label(
  ...
  const UseTimeSlicing = value$$1 =>
    ok$1({ type: "UseTimeSlicing", value: value$$1 })

  const ignore = () => {}

  var Triangles = Object.freeze({
    Model: Model,
    update: update,
    view: view
  })
  ...
  flatbuffers.Builder.prototype.endObject = function() {
    ...
    this.addInt16(
      (this.vtable_in_use + standard_fields) * flatbuffers.SIZEOF_SHORT
    )
  ...
  class FieldError$1 extends DecoderError {
    ...
    format(context) {
      ...
      return `Faild to decode a field "${this.fieldName}" from "${
        this.table.name
      }" table${where}`
    }
  }
  ...
  class VariantError extends DecoderError {
    ...
    format(context) {
      ...
      return `Faild to decode a union "${this.table.name}" as ${optionName}:${
        option
      }`
    }
  }
  ...
  class Property {
    ...
    valueType() {
      ...
      return offset
        ? /** @type {JSONType} */ this.bb.readUint8(this.bb_pos + offset)
        : JSONVariant.NONE
    }
  ...
  class Boolean$3 {
    ...
    static getRootAsBoolean(bb, obj) {
      return (obj || new Boolean$3()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Integer$3 {
    ...
    static getRootAsInteger(bb, obj) {
      return (obj || new Integer$3()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class String$4 {
    ...
    static getRootAsString(bb, obj) {
      return (obj || new String$4()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Accessor$1 {
    ...
    static getRootAsAccessor(bb, obj) {
      return (obj || new Accessor$1()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Boolean$2 {
    ...
    static getRootAsPrimitive(bb, obj) {
      return (obj || new Boolean$2()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Dictionary$1 {
    ...
    static getRootAsDictionary(bb, obj) {
      return (obj || new Dictionary$1()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Either$1 {
    ...
    static getRootAsEither(bb, obj) {
      return (obj || new Either$1()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Undefined$1 {
    ...
    static getRootAsUndefined(bb, obj) {
      return (obj || new Undefined$1()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Optional$1 {
    ...
    static getRootAsOptional(bb, obj) {
      return (obj || new Optional$1()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Integer$2 {
     ...
     */
    static getRootAsInteger(bb, obj) {
      return (obj || new Integer$2()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class String$3 {
     ...
     */
    static getRootAsString(bb, obj) {
      return (obj || new String$3()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class And$1 {
    ...
    leftType() {
      var offset = this.bb.__offset(this.bb_pos, 4)
      return offset
        ? /** @type {Decoder} */ this.bb.readUint8(this.bb_pos + offset)
        : decoder.NONE
    }
  ...
  class Match$1 {
    ...
    valueType() {
      var offset = this.bb.__offset(this.bb_pos, 4)
      return offset
        ? /** @type {JSON.JSON} */ this.bb.readUint8(this.bb_pos + offset)
        : JSONVariant.NONE
    }
  ...
  class AddEventListener {
    ...
    decoderType() {
      var offset = this.bb.__offset(this.bb_pos, 8)
      return offset
        ? /** @type {Decoder.Decoder} */ this.bb.readUint8(this.bb_pos + offset)
        : decoder.NONE
    }
  ...
  class Change$1 {
    ...
    static getRootAsChange(bb, obj) {
      return (obj || new Change$1()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      )
    }
  ...
  class Element$1 extends Element {
    static encode(builder, value) {
      ...
      const encodedValue =
        type === JSONVariant.NONE ? null : JSON$1.encode(builder, value)
  ...
  class Form$2 extends Form$1 {
    static encode(builder, fields) {
      const encodedFields = Form$2.createFormVector(
        builder,
  ...
  class Record$1 extends Record {
    static encode(builder, fields) {
      const encodedFields = Record$1.createFieldsVector(
        builder,
        Fields.encode(builder, fields)
      )
  ...
  class AssignBooleanProperty$1 extends AssignBooleanProperty {
    constructor(...args) {
      ...
      return (
        (_temp = super(...args)),
        (this.opType = opType.AssignBooleanProperty),
        _temp
      )
    }
  ...
  class AssignNullProperty$1 extends AssignNullProperty {
    constructor(...args) {
      ...
      return (
        (_temp2 = super(...args)),
        (this.opType = opType.AssignNullProperty),
        _temp2
      )
    }
  ...
  class AssignNumberProperty$1 extends AssignNumberProperty {
    constructor(...args) {
      ...
      return (
        (_temp3 = super(...args)),
        (this.opType = opType.AssignNumberProperty),
        _temp3
      )
    }
  ...
  class AssignStringProperty$1 extends AssignStringProperty {
    constructor(...args) {
      ...
      return (
        (_temp4 = super(...args)),
        (this.opType = opType.AssignStringProperty),
        _temp4
      )
    }
  ...
  class DeleteProperty$1 extends DeleteProperty {
    constructor(...args) {
      ...
      return (
        (_temp5 = super(...args)), (this.opType = opType.DeleteProperty), _temp5
      )
    }
  ...
  class AddEventListener$1 extends AddEventListener {
    constructor(...args) {
      ...
      return (
        (_temp6 = super(...args)),
        (this.opType = opType.AddEventListener),
        _temp6
      )
    }
  ...
  class RemoveEventListener$1 extends RemoveEventListener {
    constructor(...args) {
      ...
      return (
        (_temp7 = super(...args)),
        (this.opType = opType.RemoveEventListener),
        _temp7
      )
    }
  ...
  class DiscardStashed$1 extends DiscardStashed {
    constructor(...args) {
      ...
      return (
        (_temp8 = super(...args)), (this.opType = opType.DiscardStashed), _temp8
      )
    }
  ...
  class ShiftSiblings$1 extends ShiftSiblings {
    constructor(...args) {
      ...
      return (
        (_temp9 = super(...args)), (this.opType = opType.ShiftSiblings), _temp9
      )
    }
  ...
  class EditTextData$1 extends EditTextData {
    constructor(...args) {
      ...
      return (
        (_temp10 = super(...args)), (this.opType = opType.EditTextData), _temp10
      )
    }
  ...
  class InsertComment$1 extends InsertComment {
    constructor(...args) {
      ...
      return (
        (_temp11 = super(...args)),
        (this.opType = opType.InsertComment),
        _temp11
      )
    }
  ...
  class InsertElement$1 extends InsertElement {
    constructor(...args) {
      ...
      return (
        (_temp12 = super(...args)),
        (this.opType = opType.InsertElement),
        _temp12
      )
    }
  ...
  class InsertStashedNode$1 extends InsertStashedNode {
    constructor(...args) {
      ...
      return (
        (_temp13 = super(...args)),
        (this.opType = opType.InsertStashedNode),
        _temp13
      )
    }
  ...
  class InsertText$1 extends InsertText {
    constructor(...args) {
      ...
      return (
        (_temp14 = super(...args)), (this.opType = opType.InsertText), _temp14
      )
    }
  ...
  class RemoveAttribute$1 extends RemoveAttribute {
    constructor(...args) {
      ...
      return (
        (_temp15 = super(...args)),
        (this.opType = opType.RemoveAttribute),
        _temp15
      )
    }
  ...
  class RemoveNextSibling$1 extends RemoveNextSibling {
    constructor(...args) {
      ...
      return (
        (_temp16 = super(...args)),
        (this.opType = opType.RemoveNextSibling),
        _temp16
      )
    }
  ...
  class RemoveStyleRule$1 extends RemoveStyleRule {
    constructor(...args) {
      ...
      return (
        (_temp17 = super(...args)),
        (this.opType = opType.RemoveStyleRule),
        _temp17
      )
    }
  ...
  class ReplaceWithComment$1 extends ReplaceWithComment {
    constructor(...args) {
      ...
      return (
        (_temp18 = super(...args)),
        (this.opType = opType.ReplaceWithComment),
        _temp18
      )
    }
  ...
  class ReplaceWithElement$1 extends ReplaceWithElement {
    constructor(...args) {
      ...
      return (
        (_temp19 = super(...args)),
        (this.opType = opType.ReplaceWithElement),
        _temp19
      )
    }
  ...
  class ReplaceWithStashedNode$1 extends ReplaceWithStashedNode {
    constructor(...args) {
      ...
      return (
        (_temp20 = super(...args)),
        (this.opType = opType.ReplaceWithStashedNode),
        _temp20
      )
    }
  ...
  class ReplaceWithText$1 extends ReplaceWithText {
    constructor(...args) {
      ...
      return (
        (_temp21 = super(...args)),
        (this.opType = opType.ReplaceWithText),
        _temp21
      )
    }
  ...
  class SelectChildren$1 extends SelectChildren {
    constructor(...args) {
      ...
      return (
        (_temp22 = super(...args)),
        (this.opType = opType.SelectChildren),
        _temp22
      )
    }
  ...
  class SelectParent$1 extends SelectParent {
    constructor(...args) {
      ...
      return (
        (_temp23 = super(...args)), (this.opType = opType.SelectParent), _temp23
      )
    }
  ...
  class SelectSibling$1 extends SelectSibling {
    constructor(...args) {
      ...
      return (
        (_temp24 = super(...args)),
        (this.opType = opType.SelectSibling),
        _temp24
      )
    }
  ...
  class SetAttribute$1 extends SetAttribute {
    constructor(...args) {
      ...
      return (
        (_temp25 = super(...args)), (this.opType = opType.SetAttribute), _temp25
      )
    }
  ...
  class SetStyleRule$1 extends SetStyleRule {
    constructor(...args) {
      ...
      return (
        (_temp26 = super(...args)), (this.opType = opType.SetStyleRule), _temp26
      )
    }
  ...
  class SetTextData$1 extends SetTextData {
    constructor(...args) {
      ...
      return (
        (_temp27 = super(...args)), (this.opType = opType.SetTextData), _temp27
      )
    }
  ...
  class StashNextSibling$1 extends StashNextSibling {
    constructor(...args) {
      ...
      return (
        (_temp28 = super(...args)),
        (this.opType = opType.StashNextSibling),
        _temp28
      )
    }
  ...
  class UnknownOpType extends DecoderError {
    ...
    format(context) {
      const where = context == null ? "" : `at ${context}`
      return `Encountered unknown opType:${this.opType.toString()} in "Change" table${
        where
      }`
    }
  }
  ...
  class FlatBufferEncoder {
    ...
    change(opType, opOffset) {
      return this.reset(
        this.builder,
        push$2(Change.encode(this.builder, opType, opOffset), this.log)
      )
    }
    ...
    static selectChildren(state) {
      return state.change(
        SelectChildren$1.opType,
        SelectChildren$1.encode(state.builder)
      )
    }
    static selectSibling(state, offset) {
      return state.change(
        SelectSibling$1.opType,
        SelectSibling$1.encode(state.builder, offset)
      )
    }
    static selectParent(state) {
      return state.change(
        SelectParent$1.opType,
        SelectParent$1.encode(state.builder)
      )
    }
    static removeNextSibling(state) {
      return state.change(
        RemoveNextSibling$1.opType,
        RemoveNextSibling$1.encode(state.builder)
      )
    }
    ...
    static insertText(state, data) {
      return state.change(
        InsertText$1.opType,
        InsertText$1.encode(state.builder, data)
      )
    }
    static insertComment(state, data) {
      return state.change(
        InsertComment$1.opType,
        InsertComment$1.encode(state.builder, data)
      )
    }
    static insertElement(state, localName) {
      return state.change(
        InsertElement$1.opType,
        InsertElement$1.encode(state.builder, null, localName)
      )
    }
    static insertElementNS(state, namespaceURI, localName) {
      return state.change(
        InsertElement$1.opType,
        InsertElement$1.encode(state.builder, namespaceURI, localName)
      )
    }
    static insertStashedNode(state, address) {
      return state.change(
        InsertStashedNode$1.opType,
        InsertStashedNode$1.encode(state.builder, address)
      )
    }

    static replaceWithText(state, data) {
      return state.change(
        ReplaceWithText$1.opType,
        ReplaceWithText$1.encode(state.builder, data)
      )
    }
    static replaceWithComment(state, data) {
      return state.change(
        ReplaceWithComment$1.opType,
        ReplaceWithComment$1.encode(state.builder, data)
      )
    }
    static replaceWithElement(state, localName) {
      return state.change(
        ReplaceWithElement$1.opType,
        ReplaceWithElement$1.encode(state.builder, null, localName)
      )
    }
    static replaceWithElementNS(state, namespaceURI, localName) {
      return state.change(
        ReplaceWithElement$1.opType,
        ReplaceWithElement$1.encode(state.builder, namespaceURI, localName)
      )
    }
    static replaceWithStashedNode(state, address) {
      return state.change(
        ReplaceWithStashedNode$1.opType,
        ReplaceWithStashedNode$1.encode(state.builder, address)
      )
    }

    static editTextData(state, start, end, prefix, suffix) {
      return state.change(
        EditTextData$1.opType,
        EditTextData$1.encode(state.builder, start, end, prefix, suffix)
      )
    }
    static setTextData(state, data) {
      return state.change(
        SetTextData$1.opType,
        SetTextData$1.encode(state.builder, data)
      )
    }
    static setAttribute(state, name, value) {
      return state.change(
        SetAttribute$1.opType,
        SetAttribute$1.encode(state.builder, null, name, value)
      )
    }
    static removeAttribute(state, name) {
      return state.change(
        RemoveAttribute$1.opType,
        RemoveAttribute$1.encode(state.builder, null, name)
      )
    }
    static setAttributeNS(state, namespaceURI, name, value) {
      return state.change(
        SetAttribute$1.opType,
        SetAttribute$1.encode(state.builder, namespaceURI, name, value)
      )
    }
    static removeAttributeNS(state, namespaceURI, name) {
      return state.change(
        RemoveAttribute$1.opType,
        RemoveAttribute$1.encode(state.builder, namespaceURI, name)
      )
    }
    static assignProperty(state, name, value) {
      switch (typeof value) {
        case "string": {
          return state.change(
            AssignStringProperty$1.opType,
            AssignStringProperty$1.encode(state.builder, name, value)
          )
        }
        case "number": {
          return state.change(
            AssignNumberProperty$1.opType,
            AssignNumberProperty$1.encode(state.builder, name, value)
          )
        }
        case "boolean": {
          return state.change(
            AssignBooleanProperty$1.opType,
            AssignBooleanProperty$1.encode(state.builder, name, value)
          )
        }
        default: {
          if (value === null) {
            return state.change(
              AssignNullProperty$1.opType,
              AssignNullProperty$1.encode(state.builder, name, value)
            )
          } else {
            return unreachable(value)
          }
    ...
    static deleteProperty(state, name) {
      return state.change(
        DeleteProperty$1.opType,
        DeleteProperty$1.encode(state.builder, name)
      )
    }
    static setStyleRule(state, name, value) {
      return state.change(
        SetStyleRule$1.opType,
        SetStyleRule$1.encode(state.builder, name, value)
      )
    }
    static removeStyleRule(state, name) {
      return state.change(
        RemoveStyleRule$1.opType,
        RemoveStyleRule$1.encode(state.builder, name)
      )
    }
    static addEventDecoder(state, type, decoder, capture$$1) {
      return state.change(
        AddEventListener$1.opType,
        AddEventListener$1.encode(state.builder, type, decoder, capture$$1)
      )
    }
    static removeEventDecoder(state, type, decoder, capture$$1) {
      return state.change(
        RemoveEventListener$1.opType,
        RemoveEventListener$1.encode(state.builder, type, decoder, capture$$1)
      )
    }

    static stashNextSibling(state, address) {
      return state.change(
        StashNextSibling$1.opType,
        StashNextSibling$1.encode(state.builder, address)
      )
    }
    static discardStashedNode(state, address) {
      return state.change(
        DiscardStashed$1.opType,
        DiscardStashed$1.encode(state.builder, address)
      )
    }
    static shiftSiblings(state, count) {
      return state.change(
        ShiftSiblings$1.opType,
        ShiftSiblings$1.encode(state.builder, count)
      )
    }
  ...
  var requestPolyfilledAnimationFrame_1 = createCommonjsModule(function(
    module,
    exports
  ) {
    ...
    var requestPolyfilledAnimationFrame = (exports.requestPolyfilledAnimationFrame = function requestPolyfilledAnimationFrame(
      callback
    ) {
      var time = now()
    ...
    var cancelPolyfilledAnimationFrame = (exports.cancelPolyfilledAnimationFrame = function cancelPolyfilledAnimationFrame(
      id
    ) {
    ...
    var cancelAnimationFrame = (exports.cancelAnimationFrame =
      typeof window === "undefined"
              ...
              : typeof window.oCancelAnimationFrame === "function"
                ...
                : typeof window.msCancelRequestAnimationFrame === "function"
                  ...
                  : typeof window.mozCancelRequestAnimationFrame === "function"
                    ...
                    : typeof window.webkitCancelRequestAnimationFrame ===
                      "function"
                      ? function(id) {
                          return window.webkitCancelRequestAnimationFrame(id)
                        }
                      : typeof window.oCancelRequestAnimationFrame ===
                        "function"
                        ? function(id) {
  ...
  var requestPolyfilledAnimationFrame_2 =
    requestPolyfilledAnimationFrame_1.cancelAnimationFrame
  var requestPolyfilledAnimationFrame_3 =
    requestPolyfilledAnimationFrame_1.requestAnimationFrame
  var requestPolyfilledAnimationFrame_4 =
    requestPolyfilledAnimationFrame_1.cancelPolyfilledAnimationFrame
  var requestPolyfilledAnimationFrame_5 =
  ...
  const tick = () => {
    ...
    requestPolyfilledAnimationFrame_3(tick)
  }

  const program = new Program(Triangles)
  program.transact(Model.new(new Date().getTime(), setInterval(beat, 1000)))
