...
class Model {
  ...
  static useTimeSlicing({ seconds, intervalID, start, time }, useTimeSlicing) {
...
const UseTimeSlicing = value$$1 => ok$1({ type: "UseTimeSlicing", value: value$$1 });
  ...
  schedule(state) {
    ...
    if (state.useTimeSlicing) {
      if (this.requestID == null) {
        this.requestID = preemptiveAnimationFrame_3(() => this.transact(this.state));
      }
    } else {
      if (this.requestID) {
